...
<body>
	...
	<div class="container">
	   <form action="order_info_process.jsp" id="ShippingInformationForm" class="form-horizontal" method="post">
	...
	<div class="col-sm-3">
	 ...
	 <div class="form-group row">
	   <label class="col-sm-2">국가명</label>
	     <div class="col-sm-3">
		<select name="order" form="ShippingInformationForm">
            ...
            <div>
                ...
                <input type="text" id="sample4_roadAddress" name="addressName" placeholder="도로명주소">
	...
	<div class="form-group row">
	   <div class="col-sm-offset-2 col-sm-10 ">
		...
		<a hre="order_cancelled.jsp" class="btn btn-secondary" role="button"> 취소 </a>
	   </div>
	</div>
...
document.getElementById('shippingDate').min = nextDate;
</script>
<script>
    new daum.Postcode({
